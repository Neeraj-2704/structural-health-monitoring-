...
import { AppShell } from "../components/shm/AppShell";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This sensor route doesn't exist on the dashboard.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "SHM Console — IoT Structural Health Monitoring" },
      {
        name: "description",
        content:
          "Real-time IoT-based structural health monitoring dashboard for buildings — sensor telemetry, damage alerts, and maintenance tracking.",
      },
