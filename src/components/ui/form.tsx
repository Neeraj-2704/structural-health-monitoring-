...
const FormLabelComponent = FormLabel;
const FormControlComponent = FormControl;
const FormDescriptionComponent = FormDescription;
const FormMessageComponent = FormMessage;
const FormFieldComponent = FormField;

export {
  useFormField,
  FormComponent as Form,
  FormItemComponent as FormItem,
  FormLabelComponent as FormLabel,
  FormControlComponent as FormControl,
  FormDescriptionComponent as FormDescription,
  FormMessageComponent as FormMessage,
