...
const SidebarFooterComponent = SidebarFooter;
const SidebarGroupComponent = SidebarGroup;
const SidebarGroupActionComponent = SidebarGroupAction;
const SidebarGroupContentComponent = SidebarGroupContent;
const SidebarGroupLabelComponent = SidebarGroupLabel;
const SidebarHeaderComponent = SidebarHeader;
const SidebarInputComponent = SidebarInput;
const SidebarInsetComponent = SidebarInset;
const SidebarMenuComponent = SidebarMenu;
const SidebarMenuActionComponent = SidebarMenuAction;
const SidebarMenuBadgeComponent = SidebarMenuBadge;
const SidebarMenuButtonComponent = SidebarMenuButton;
const SidebarMenuItemComponent = SidebarMenuItem;
const SidebarMenuSkeletonComponent = SidebarMenuSkeleton;
const SidebarMenuSubComponent = SidebarMenuSub;
const SidebarMenuSubButtonComponent = SidebarMenuSubButton;
const SidebarMenuSubItemComponent = SidebarMenuSubItem;
const SidebarProviderComponent = SidebarProvider;
const SidebarRailComponent = SidebarRail;
const SidebarSeparatorComponent = SidebarSeparator;
const SidebarTriggerComponent = SidebarTrigger;
